<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/SupperMarket/Site1.Master" AutoEventWireup="true" CodeBehind="Privacy.aspx.cs" Inherits="Ironika_Theme1.Panel.SupperMarket.Privacy" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title> حریم خصوصی/پنل کاربری</title>
    <style>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_PageName" runat="server">
    <h1>حریم خصوصی</h1>
    <small class="subtitle"> مدیریت حریم خصوصی</small>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_Body" runat="server">
    <div class="panel widget light-widget">
        ...
        <div class="panel-body">
            <h2 class="mgbt-xs-20">مدیریت حریم خصوصی
            </h2>
    ...
    <div class="panel widget light-widget">
        ...
        <div class="panel-body" style="direction: rtl; text-align: right">
            <h2 class="mgbt-xs-20"> حریم خصوصی</h2>
