<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site1.Master" AutoEventWireup="true" CodeBehind="ChangePass.aspx.cs" Inherits="Ironika_Theme1.User.ChangePass" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_PageName" runat="server">
    ...
    <small>صفحه تغییر کلمه عبور</small>
</asp:Content>
