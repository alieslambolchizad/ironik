...
jQuery(function ($) {
    "use strict";
    $(".expander-list").find("ul").show().end().find(" .expander").text("-").end().find(".active").each(function () {
        ...
        $this.click(function () {
            if ($ul.css("display") ==
                "none") { $ul.slideDown("slow"); $(this).html("-"); }
            else {
                $ul.slideUp("slow");
...
jQuery(function ($) {
    ...
    $(".collapsed-none .expander").click(function (e) {
        var collapse_content_selector = $(this).attr("href");
        var expander = $(this);
        if (!$(collapse_content_selector).hasClass("open")) expander.removeClass("open").html("-");
        else expander.addClass("open").html("+"); if (!$(collapse_content_selector).hasClass("open")) $(collapse_content_selector).removeClass("open").slideDown("normal");
        else $(collapse_content_selector).addClass("open").slideUp("normal");
        e.preventDefault()
    })
});
jQuery(function ($) {
